            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('company.update',$company->id)}}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <img style="width: 150px;border-radius: 50%;display: block;margin: 30px auto" src="{{asset('storage/'.$company->logo)}}" alt="company logo">
                        <div class="mb-3">
                            <label for="recipient-name" class="col-form-label">Company Name:</label>
                            <input type="text" name="name" value="{{$company->name}}" class="form-control" id="recipient-name">
                        </div>
                        <div class="mb-3">
                            <label for="recipient-name" class="col-form-label">Company Address:</label>
                            <input type="text" name="address" value="{{$company->address}}" class="form-control" id="recipient-name">
                        </div>
                        <div class="mb-3">
